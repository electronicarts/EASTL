...
namespace Thread {
		...
		inline bool SetThreadPriority(int priority) {
			...
			// Get the min/max priority for the scheduler. This can varry per system and per scheduler.
			...
			// Probbably necessary. References claim that negative priorities require root access.
			...
			// It is noted that programs should not relying on this behavour as it could be rectified eventually.
