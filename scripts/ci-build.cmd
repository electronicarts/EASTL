...
if not [x%PLATFORM:2013=%]==[x%PLATFORM%]      ( set vs_generator=Visual Studio 12 2013 )
else if not [x%PLATFORM:2015=%]==[x%PLATFORM%] ( set vs_generator=Visual Studio 14 2015 )
else                                           ( set vs_generator=Visual Studio 15 2017 )
